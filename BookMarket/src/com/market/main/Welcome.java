...
public class Welcome {
	...
	public static void menuIntroduction() {
		System.out.println("***********************************************");
		System.out.println(" 1. 고객 정보 확인하기 \t4. 장바구니에 항목 추가하기");
		System.out.println(" 2. 장바구니 항목 수량 보기 \t5. 장바구니의 항목 수량 줄이기");
		System.out.println(" 3. 장바구니 비우기 \t6. 장바구니의 항목 삭제하기");
		System.out.println(" 7. 영수증 표시하기 \t8. 종료");
	...
	public static void menuCartClear() throws CartException {
		...
		// System.out.println("장바구니에 항목이 없습니다");
			...
			if (str.toUpperCase().equals("Y")) {
				System.out.println("장바구니의 모든 항목을 삭제하겠습니다");
	...
	public static void menuCartAddItem(ArrayList<Book> booklist) {
		...
		while (!quit) {
			...
			if (flag) {
				System.out.println("장바구니 추가하겠습니까?  Y  | N ");
				str = input.nextLine();
				if (str.toUpperCase().equals("Y")) {
		...
		if (adminId.equals(admin.getId()) && adminPW.equals(admin.getPassword())) {
			...
			if (str.toUpperCase().equals("Y")) {
				...
				try {
					...
					fw.close();
					System.out.println("새 도서 정보가 입력되었습니다.");
				} catch (Exception e) {
	...
	public static void BookList(ArrayList<Book> booklist) {
		 ...
		 * 
		 * booklist[0].setDescription("단계별로 쇼핑몰을 구현하는 JSP 웹 프로그래밍");
